...
describe('combineBooleans', () => {
	it(
        'should combine booleans according to the AND principle when both are true',
        async () => {
	...
	it(
        'should combine booleans according to the AND principle when both are false',
        async () => {
	...
	it(
        'should combine booleans according to the AND principle when one observable is false',
        async () => {
            const booleanObservableA = of(true);
            const booleanObservableB = of(false);
