...
const createLoader = (
	...
	client: { getTranslations: jest.Mock } | null,
	paths: string[],
	configuration: NgxI18nConfiguration = {}
	...
	const injector = Injector.create({
		providers: [
			...
			{ provide: NgxI18nConfigurationToken, useValue: configuration },
...
describe('NgxI18nMultiTranslationHttpLoader', () => {
	describe('getTranslation', () => {
		...
		beforeEach(() => {
			...
			loader = createLoader(
				loadingServiceMock as unknown as NgxI18nLoadingService,
				customClientMock,
				['assets/i18n/common/', 'assets/i18n/feature/'],
				{ cacheBust: '1.0' }
			);
		});
