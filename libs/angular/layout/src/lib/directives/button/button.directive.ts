...
export class NgxButtonDirective implements OnInit {
	 ...
	 */
	private readonly elementRef: ElementRef<HTMLButtonElement> = inject(
	 ...
	 */
	private iconComponent: ComponentRef<NgxDisplayContentComponent>;

	private loadingComponent: ComponentRef<NgxDisplayContentComponent>;
