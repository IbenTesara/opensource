import { Directive, ElementRef, HostBinding, HostListener, Input, Type, inject } from '@angular/core';
...
export class NgxTooltipDirective {
	 ...
	 */
	@HostBinding('attr.aria-describedby') @Input() public ngxTooltipId: string = uuid();
