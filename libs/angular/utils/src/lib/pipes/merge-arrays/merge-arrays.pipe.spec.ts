...
describe('mergeArrays', () => {
	...
	describe('transform', () => {
		it(
            'should return an empty array when the source is an invalid array',
            () => {
		...
		it(
            'should return the source array without further operators with no additional arguments provided',
            () => {
		...
		it(
            'should return the source array with additional arrays where some are undefined or null',
            () => {
