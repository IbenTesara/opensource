...
describe('WordCountValidator', () => {
	...
	it(
        'should not give an error when the value is a string that does not exceed the maximum word count',
        () => {
	...
	it(
        'should give an error when the value is a string that does exceed the maximum word count',
        () => {
	...
	it(
        'should give an error when the value is a string that does not exceed the minimum word count',
        () => {
